...
export const metadata: Metadata = {
  title: "SEO Company in Madurai | Local SEO Services Agency",
  description: "Looking for the best SEO company in Madurai? We rank local businesses, retail stores, and service firms on Google Page 1. Get a free SEO blueprint.",
  alternates: {
    canonical: "https://joydigital.in/seo-company-madurai",
  },
};
...
const pageSchema = {
  ...
  "@type": "Service",
  "name": "SEO & Digital Marketing Services in Madurai",
  ...
  "description": "Joy Digital is a result-oriented SEO company in Madurai, helping businesses drive traffic, rank high for local terms, and optimize search CTRs.",
  "offers": {
    "@type": "AggregateOffer",
    "priceCurrency": "INR",
    "lowPrice": "15000",
...
export default function SeoCompanyMadurai() {
  return (
    <ServicePageTemplate
      serviceName="SEO Company Madurai"
      heroTitle="SEO Company in Madurai"
      heroSubtitle="Rank higher on Google and bring more customers to your business. As a top SEO agency in Madurai, we optimize websites to gain organic local traffic and maps visibility."
      leadSource="SEO Company Madurai Landing Page"
      heroCtaText="Get Free SEO Audit"
      canonicalUrl="https://joydigital.in/seo-company-madurai"
      overviewTitle="Increase Search Visibility & Rank for Keywords That Bring Leads"
      overviewContent={
        <div className="space-y-6">
          <p>
            If your website isn&apos;t ranking on page 1 of Google, you are losing valuable customers to competitors every single day. Most buyers looking for services in Madurai do not scroll past the first three Google Maps results or organic web links.
          </p>
          <p>
            At Joy Digital, we provide result-oriented SEO services in Madurai. We perform thorough technical site audits, target local keywords, build local search citations, and improve your click-through rates.
          </p>
        </div>
      }
