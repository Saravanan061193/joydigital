...
export const metadata: Metadata = {
  title: "Professional SEO Services in the UK | Grow Organic Traffic | Joy Digital",
  description: "Rank higher on Google in the UK market, attract organic leads, and dominate search results. We offer comprehensive on-page, off-page, and technical SEO campaigns.",
};

const pageSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "name": "Professional SEO Services UK",
  ...
  "description": "Joy Digital helps UK businesses improve search rankings, target transactional keywords, and optimize technical page structures.",
  "offers": {
    "@type": "AggregateOffer",
    "priceCurrency": "GBP",
    "lowPrice": "200",
...
export default function SEOPageUK() {
  return (
    <ServicePageTemplate
      serviceName="SEO Services UK"
      heroTitle="Grow Organic Sales Leads with UK SEO Services"
      heroSubtitle="Improve search engine rankings in the UK market, attract high-intent visitors to your offer, and outperform competitors. We implement research-backed optimization campaigns that generate consistent search queries."
      leadSource="SEO Services UK Landing Page"
      overviewTitle="Organic UK Rankings Built on Analytics, Code Optimization & Quality Copy"
      overviewContent={
        <div className="space-y-6">
          <p>
            Competing in the UK digital market requires a targeted search strategy. Pay-per-click costs continue to rise, making organic search engine optimization (SEO) a key channel for acquiring sustainable traffic and qualified client leads.
          </p>
          <p>
            At Joy Digital Growth Agency, we help UK businesses optimize their search visibility. We conduct detailed keyword research, resolve page speed bottlenecks, and build authoritative local citation links. This comprehensive approach helps improve search presence and support sales growth.
          </p>
        </div>
      }
      benefitsTitle="How Search Engine Optimization Drives Growth in the UK"
      ...
      benefits={[
        ...
        },
        {
          ...
          description: "Ranking on the first page of Google helps establish your brand's authority, making UK prospects more comfortable choosing your business.",
        },
        {
      ...
      processTitle="Our UK SEO Optimization Process"
      ...
      crossLinks={[
        ...
        { href: "/website-development-uk", label: "Web Dev UK" },
      ]}
    />
  );
}
