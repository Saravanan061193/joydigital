    ...
    <ServicePageTemplate
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "Google verifies profiles via video recording, phone, email, or postcard. Phone/email verification happens instantly. Postcards take 7 to 14 business days to arrive in Madurai.",
        },
      ]}
