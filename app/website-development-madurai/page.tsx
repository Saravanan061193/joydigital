...
export const metadata: Metadata = {
  title: "Website Development in Madurai | Custom Web Design",
  description: "Looking for website development in Madurai? We code fast, mobile-friendly Next.js and React websites for local startups and growing brands.",
  alternates: {
...
export default function WebDevMaduraiSimple() {
  return (
    <ServicePageTemplate
      serviceName="Website Development Madurai"
      heroTitle="Website Development in Madurai"
      heroSubtitle="Get dynamic, mobile-friendly React and Next.js website assets. We build fast corporate portfolios that convert visitors into active customers."
      leadSource="Website Development Madurai Simple Landing Page"
      canonicalUrl="https://joydigital.in/website-development-madurai"
      overviewTitle="High-Performance Website Design & Development in Madurai"
      overviewContent={
        <div className="space-y-6 text-justify">
          <p>
            In the historical and rapidly growing city of Madurai, traditional business setups are rapidly transitioning to digital channels. Whether you operate a retail store near the Meenakshi Amman Temple, a healthcare clinic in Anna Nagar, or an agricultural business in the outskirts, having a slow, generic website is no longer enough to stay competitive. We are a specialized website development company in Madurai focused on delivering custom, high-speed React and Next.js websites. Our projects completely bypass database bottlenecks and heavy, vulnerable scripts, delivering pages that load in under 1.5 seconds on standard mobile networks.
          </p>
          <p>
      ...
      faqs={[
        ...
        },
        {
          ...
          answer: "Yes. We can extract your existing content, structure a clean Next.js React layout, and set up redirections. This preserves your rankings.",
        },
      ]}
