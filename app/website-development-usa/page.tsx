...
export const metadata: Metadata = {
  title: "Professional Website Development Services in the USA | Joy Digital",
...
const pageSchema = {
  ...
  "@type": "Service",
  "name": "Custom Website Development Services USA",
...
export default function WebDevPageUSA() {
  return (
    <ServicePageTemplate
      serviceName="Website Development USA"
      ...
      leadSource="Website Development USA Landing Page"
      ...
      crossLinks={[
        ...
        { href: "/seo-services-usa", label: "SEO Services USA" },
      ]}
    />
  );
}
